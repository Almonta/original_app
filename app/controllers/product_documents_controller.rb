class ProductDocumentsController < ApplicationController
  ...
  def edit
    redirect_to product_path(@product.id) unless (current_user == @product_document.user) || (current_user.name == "ゲスト") || (current_user.name == "管理者")
  end
  ...
  def destroy
    return redirect_to product_path(@product.id) unless (current_user == @product_document.user) || (current_user.name == "ゲスト") || (current_user.name == "管理者")
